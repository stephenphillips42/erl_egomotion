...
%   outliers specified by the outlierRate, to generate syntetic flow. Outlier are generated by
%   picking a norm from the existing norm distribution and picking a direction uniformly at random.
% Parameters (all optional):
% rngSeed - integer specifying random seed for repeatibility. If not specified, not set
% nPoints - positive integer specifying number of flow points generated. Default: 300
% depthMin - postiive number, specifying the minimum depth points are allowed to be. Default: 5
% depthMax - postiive number, specifying the maximum depth points are allowed to be. Default: 15
% lambda - postiive number, specifying expected scale of the heading. Default: 1
% kappa - positive number, specifying expected scale of the angular velocity. Default: 0.2
% scaledT - size (3 x 1) vector, specifying the heading direction with scale (not necessarly with
%           norm 1). If specified, lambda parameter is not used. The value of trueT is computed from
%           this by making it norm 1. Default: Generated randomly
% trueOmega - size (3 x 1) vector, specifying the angular velocity. If used, the property kappa is
%             disregarded. Default: Generated randomly
% noiseLevel - positive number, used as the standard deviation of the Gaussian noise added to the
%              flow vectors. Default: 0.1
% outlierRate - number in [0,1], specifying percentage of the flow points that are outliers.
%               Default: 0
